...
public class Student {
    ...
    public String toJSONstring() {
        ...
        try {
            result += "\t\"first_name\":\"" + AESImpl.encrypt(first_name) + "\"," + System.lineSeparator();
            result += "\t\"last_name\":\"" + AESImpl.encrypt(last_name) + "\"," + System.lineSeparator();
            result += "\t\"CPR\":\"" + AESImpl.encrypt("DKGuldIHaandBold"+cpr) + "\"," + System.lineSeparator();
        } catch (Exception e) {
            e.printStackTrace();
        }
